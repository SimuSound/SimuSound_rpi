...
extern "C"
{
  ...
  typedef enum
  {
    ...
    AGB0_REG_WHO_AM_I = 0x75,  // ICM-20689
    AGB0_REG_LPF,
    // Break
    ...
    // AGB0_REG_PWR_MGMT_1,
    AGB0_REG_PWR_MGMT_1 = 0x6B,  // ICM-20689
    AGB0_REG_PWR_MGMT_2,
    // Break
    ...
    AGB0_REG_ACCEL_XOUT_H = 0x3B,  // ICM-20689
    ...
    AGB0_REG_GYRO_XOUT_H = 0x43,  // ICM-20689
    ...
    AGB2_REG_GYRO_CONFIG_1 = 0x1B,  // ICM-20689
    ...
    AGB2_REG_ACCEL_CONFIG = 0x1C,  // ICM-20689
  ...
  typedef struct  // ICM-20689
  {
    uint8_t GYRO_FCHOICE : 2;
    uint8_t reserved_0 : 1;
    uint8_t GYRO_FS_SEL : 2;
